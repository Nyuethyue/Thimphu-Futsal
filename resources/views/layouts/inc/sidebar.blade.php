<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <!-- <div class="image">
          <img src="img/futsal_logo.jpg" class="img-circle elevation-2" alt="User Image">
        </div> -->
        <div class="info">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item">
              <a class="nav-link" href="{{ route('home') }}" class="d-block text-decoration-none">
                <i class="nav-icon fas fa-tachometer-alt"></i>
                <p>Dashboard</p>  
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ route('getAllUsers') }}" class="d-block text-decoration-none">
                <i class="nav-icon fas fa-tachometer-alt"></i>
                <p>User Management</p>  
              </a>
            </li>
